    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-slate-50 dark:bg-[#0c0f17] relative">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200/80 dark:border-white/10 rounded-3xl p-8 md:p-10 shadow-xl shadow-black/[0.03] dark:shadow-black/20 animate-fade-in-up">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 pl-1">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
          ...
          {secretRequired && (
            <div className="flex flex-col gap-2">
              <label htmlFor="registrationSecret" className="text-xs font-bold uppercase tracking-wider text-purple-600 dark:text-purple-400 pl-1">
                Invite Code
              </label>
              <input
                id="registrationSecret"
                type="text"
                className="w-full px-4.5 py-3 bg-slate-100 dark:bg-slate-950/80 border border-purple-500/20 dark:border-purple-500/25 rounded-2xl text-slate-900 dark:text-white text-base placeholder-slate-400 dark:placeholder-slate-500 focus:border-purple-500/50 focus:ring-4 focus:ring-purple-500/10 focus:outline-none transition-all font-semibold"
